...
const Account = () => {
   const { data, refetch } = useGetAllQuery({}, { refetchOnMountOrArgChange: true });
                                    ...
                                    <tbody>
                                       {data?.body?.data?.docs.map((item: any) => (
                                          <tr className='border-b dark:border-neutral-500'>
                                             ...
                                             <td className='block whitespace-nowrap px-6 py-4 w-[150px]'>
                                                <img
                                                   className='w-[200px] h-[100px] items-center text-center'
                                                   src={item.avatar}
                                                   alt=''
                                                />
                                             </td>
                                             ...
                                             <td className=' px-6 py-4'>
                                                <p className='w-[100px] break-all'>{item?.address}</p>
                                             </td>
