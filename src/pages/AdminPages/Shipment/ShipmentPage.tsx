                                       ...
                                       {shipment.isDisable ? (
                                          <div
                                             onClick={() =>
                                                Modal.confirm({
                                                   type: 'confirm',
                                                   title: 'Bạn muốn kích hoạt lô hàng này ?',
                                                   content:
                                                      'Toàn bộ số lượng sản phẩm trong lô hàng sẽ được cập nhật lại.',
                                                   onOk: () =>
                                             ...
                                             className='text-slate-500 flex justify-between gap-2 cursor-pointer hover:text-green-400 duration-300'
                                          >
                                             <TbPackageExport className='w-[20px]' />
                                             <span>Kích hoạt lô hàng</span>
                                          </div>
                                       ) : (
                                          <div
                                             onClick={() =>
                                                Modal.confirm({
                                                   ...
                                                   content:
                                                      'Toàn bộ số lượng sản phẩm trong lô hàng sẽ bị vô hiệu hóa.',
                                                   onOk: () =>
                                                      handleUpdateShipment({
                                                         products: shipment.products.map((product) => ({
                                                            idProduct: product.idProduct._id,
