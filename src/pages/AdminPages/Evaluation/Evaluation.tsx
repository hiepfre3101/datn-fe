                  ...
                  <div className='flex gap-7 flex-wrap justify-center' style={{ margin: 30 }}>
                     ...
                     >
                        ...
                        <Column
                           ...
                           render={(_: IEvaluationFull, record: IEvaluationFull) => {
                              return (
                                 <p>{record.phoneNumber != null ? record.phoneNumber : record.userId?.phoneNumber}</p>
                              );
                           }}
                        />
                        <Column title='Ngày đánh giá' dataIndex='createdAt' key=' ' width={40} />
                           ...
                           render={(_: IEvaluationFull, record: IEvaluationFull) => {
                              return (
                                 ...
                                 >
                                    <button
                                       type='button'
                                       className='bg-red-400 focus:outline-none text-center text-white  focus:ring-4 font-medium rounded-lg text-xs lg:text-sm px-2 py-2.5  dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900'
                                    >
