  ...
  return (
    <div>
      <div className="text-center p-10">
        ...
        <div>
          <img className="m-auto w-48 mt-[2%] mb-[5%]" src="https://spacingtech.com/html/tm/freozy/freezy-ltr/image/logo/logo.png" alt="" />
        </div>
        ...
        <div className="flex flex-col gap-3 items-center mx-auto md:w-1/2 lg:w-3/5">
          ...
          <div className="w-full md:w-1/6  md:mt-0">
            <img className='w-[100px] mx-auto' src="https://img.freepik.com/premium-vector/cute-funny-crying-sad-carrot-character_464314-1975.jpg" alt="" />
          </div>
        </div>
