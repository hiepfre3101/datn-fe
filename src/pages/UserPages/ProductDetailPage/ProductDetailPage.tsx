...
const ProductDetail = () => {
   ...
   useEffect(() => {
      setTotalWeight(
         oneProductData?.body?.data?.shipments?.reduce((accumulator: number, shipmentWeight: IShipmentOfProduct) => {
                        ...
                        <div className='product-info-wrap'>
                           ...
                           <div className='product-info md:mt-[30px] max-md:mt-[20px]'>
                              <div className='product-price text-[20px] font-bold'>
                                 {oneProductData?.body?.data?.shipments[0]?.price.toLocaleString('vi-VN', {
                                    style: 'currency',
                                    currency: 'VND'
                                 })}
                              </div>
