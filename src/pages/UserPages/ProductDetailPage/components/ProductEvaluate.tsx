      ...
      <div>
            ...
            <span className='review-title text-[20px] text-[#333333] font-bold'>
               ...
               <div className='product-rating mt-[25px] mb-[12px]'>
                  <div className='rate flex items-center'>
                     ...
                     >
                        <Rate allowHalf disabled defaultValue={data.body.data.reduce((current, evaluation) => current += evaluation.rate  , 0) / data.body.data.length} />
                     </ConfigProvider>
                  </div>
         ...
         <div className='list-review'>
            ...
            <div key={index} className='revite-item pt-[30px] pb-[30px] border-t-[1px]'>
               ...
               <p className='username mt-[9px] font-bold text-[#333333]'>{evaluation.userName!= null ? evaluation.userName : evaluation.userId?.userName}</p>
                  <p className='date mt-[5px] text-[#333333] '>{formatStringToDate(evaluation.createdAt)}</p>
               <p dangerouslySetInnerHTML={{__html: evaluation.content }} className='review-text mt-[18px]'>
